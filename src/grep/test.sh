...
reg=$"int"
    ...
    do  
        ...
        then
        (( SUCCESS++ ))
            echo "\033[0;39m Test  $flag \033[1;32mSUCCESS"
        else
        (( FAIL++ ))
    ...
    do  
       ./s21_grep -$flag $reg $file $file1 $file2> test_s21_grep.log
        ...
        then
        (( SUCCESS++ ))
            echo "\033[0;39mTest  $flag 3 files \033[1;32mSUCCESS"
        else
        (( FAIL++ ))
...
do  
    ...
    do  
        ...
        then
        (( SUCCESS++ ))
            echo "\033[0;39mTest $flag1 $flag \033[1;32mSUCCESS"
        else
        (( FAIL++ ))
...
do  
    ...
    do  
        ...
        then
        (( SUCCESS++ ))
            echo "\033[0;39mTest $flag1 $flag 2 files \033[1;32mSUCCESS"
        else
        (( FAIL++ ))
